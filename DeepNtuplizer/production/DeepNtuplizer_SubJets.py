...
updateJetCollection(
    ...
    jetSource=cms.InputTag(
        "slimmedJetsAK8PFCHSSoftDropPacked", "SubJets"
    ),  # slimmedJetsAK8PFPuppiSoftDropPacked', 'SubJets'),  # subjets from AK8
...
if hasattr(process, "updatedPatJetsTransientCorrectedFatPFCHS"):
    ...
    raise ValueError(
        "I could not find updatedPatJetsTransientCorrectedFatPFCHS to embed the tagInfos, please check the cfg"
    )
...
process.deepntuplizer.bDiscriminators.append(
