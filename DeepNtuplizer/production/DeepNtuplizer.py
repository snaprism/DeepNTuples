...
options.register(
    ...
    "select jets with good gen match",
)
options.register(
    "phase2",
    False,
    VarParsing.VarParsing.multiplicity.singleton,
    VarParsing.VarParsing.varType.bool,
    "apply jet selection for phase 2. Currently sets JetEtaMax to 3.0 and picks slimmedJetsPuppi as jet collection.",
)
options.register(
    "puppi",
    True,
...
process.GlobalTag = GlobalTag(
    process.GlobalTag, "130X_mcRun3_2023_realistic_postBPix_v2", ""
)
...
from RecoBTag.ONNXRuntime.pfParticleNetAK4_cff import (
    _pfParticleNetAK4JetTagsAll as pfParticleNetAK4JetTagsAll,
)
from RecoBTag.ONNXRuntime.pfParticleNetFromMiniAODAK4_cff import (
    _pfParticleNetFromMiniAODAK4PuppiCentralJetTagsProbs,
)
...
addProcessAndTask(
    ...
    ak4PFJetsPuppi.clone(src="packedPFCandidates", srcWeights="puppi"),
)
...
getattr(process, "patJetFlavourAssociationAK4PuppiRecluster").weights = cms.InputTag(
    "puppi"
)
...
process.patGenJetMatchAllowDuplicates = cms.EDProducer(
...
process.genJetReclusterTask = cms.Task(
    process.packedGenParticlesForJetsNoNu,
    process.ak4GenJetsWithNu,
    process.ak4GenJetsRecluster,
)
process.genJetMatchTask = cms.Task(
    process.patGenJetMatchAllowDuplicates,
