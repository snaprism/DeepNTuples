...
parser.add_argument("infiles", metavar="N", nargs="+", help="sample list files")
...
""".format(
        cwd=os.getcwd(), outdir=args.outdir
    )
...
queue
"""
    jobs = [template.format(args=val, idx=idx) for idx, val in enumerate(listtoberun)]
